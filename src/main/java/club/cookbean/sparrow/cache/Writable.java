...
public interface Writable {
    ...
    long lpushWithWriter(String key, Cacheable... values) throws CacheWritingException;

    long saddWithWriter(final String key, final Cacheable... values) throws CacheWritingException;
}
